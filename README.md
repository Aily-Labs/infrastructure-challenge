...
After obtaining the images in your cluster, it will be necessary to update the deployment YAML with the [frontend](https://github.com/jeffersonferrari/infrastructure-challenge/blob/2ccb6dadc4eb6febe05f48a44b3b22afaa8995a8/kubernetes/infrastructure-challenge.yaml#L24) and [API](https://github.com/jeffersonferrari/infrastructure-challenge/blob/2ccb6dadc4eb6febe05f48a44b3b22afaa8995a8/kubernetes/infrastructure-challenge.yaml#L29) images.
